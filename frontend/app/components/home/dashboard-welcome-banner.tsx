            ...
            <div className="flex items-start gap-4">
                ...
                <div className="space-y-2">
                    ...
                    <p className="max-w-3xl text-sm text-muted-foreground">
                        Learn where workflow activity, failures, and worker context show up. Celery Insights becomes
                        useful once task events are flowing, so the tour stays visible until the dashboard has real
                        activity.
                    </p>
                    <div className="flex flex-wrap gap-2 text-sm text-muted-foreground">
                        ...
                        <span className="rounded-full bg-background/80 px-3 py-1">
                            Inspect full workflows in one click
                        </span>
                    </div>
                </div>
            </div>
