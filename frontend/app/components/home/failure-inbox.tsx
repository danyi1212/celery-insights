            ...
            {groups.length ? (
                        ...
                        {groups.map((group) => (
                            ...
                            >
                                <div className="min-w-0 flex-1">
                                    ...
                                    <p className="truncate text-sm font-medium leading-tight text-destructive">
                                        {group.exception}
                                    </p>
                                    {group.preview && (
                ...
                <div className="flex min-h-44 flex-col items-center justify-center gap-3 px-6 py-8 text-center">
                    ...
                    <p className="max-w-lg text-sm text-muted-foreground">
                        When tasks fail, this inbox will collect the latest task type and exception groups so you can
