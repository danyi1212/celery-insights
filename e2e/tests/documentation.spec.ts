...
const docsDir = resolve(dirname(fileURLToPath(import.meta.url)), "../../src/content/docs")
...
const documentationPages = [
  {
    ...
    sourcePath: "src/content/docs/setup.mdx",
  ...
  },
  {
    ...
    sourcePath: "src/content/docs/kubernetes.mdx",
  },
  {
    title: "Celery Cluster Setups",
    href: "/documentation/celery-clusters",
    sourcePath: "src/content/docs/celery-clusters.mdx",
  },
  {
    title: "Production Notes",
    href: "/documentation/production-notes",
    sourcePath: "src/content/docs/production-notes.mdx",
  },
] as const
