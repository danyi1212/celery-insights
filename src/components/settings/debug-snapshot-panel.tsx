      ...
      <div className="space-y-6 p-4">
        <div className="rounded-2xl border bg-background/60 p-5">
          <div className="flex flex-wrap items-center gap-2">
            ...
            <Badge variant="outline">{data?.manifest.source.redacted ? "Secrets redacted" : "Secrets included"}</Badge>
          </div>
        ...
        <div className="grid gap-4 md:grid-cols-2 xl:grid-cols-4">
          ...
          <div className="rounded-2xl border bg-background/40 p-4">
            <div className="text-xs font-medium uppercase tracking-[0.18em] text-muted-foreground">Bundle format</div>
            <div className="mt-2 text-sm font-medium">v{data?.manifest.version ?? "—"}</div>
          </div>
          <div className="rounded-2xl border bg-background/40 p-4">
            <div className="text-xs font-medium uppercase tracking-[0.18em] text-muted-foreground">Replay state</div>
            <div className="mt-2 text-sm font-medium">Offline and read-only</div>
          </div>
          <div className="rounded-2xl border bg-background/40 p-4">
            <div className="text-xs font-medium uppercase tracking-[0.18em] text-muted-foreground">Source timezone</div>
