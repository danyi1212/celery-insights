  ...
  return (
    <Panel title="Broker" loading={isLoading} error={error} {...props}>
      <div className="grid grid-cols-12 gap-2 p-2">
            ...
            value={
              <div className="flex items-center">
                ...
                <Tooltip>
                  ...
                  <TooltipContent>{stats?.broker?.ssl ? "SSL Enabled" : "SSL Disabled"}</TooltipContent>
                </Tooltip>
              </div>
            }
          />
        ...
        <div className="col-span-12 md:col-span-6">
          <DetailItem label="Heartbeat Interval" value={formatSecondsDuration(stats?.broker?.heartbeat || 0)} />
        </div>
        <div className="col-span-12 md:col-span-6">
