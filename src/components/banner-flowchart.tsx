...
const createDemoTask = (task: Partial<Task>): Task => ({
  id: "?",
  type: "Hello, World!",
...
const demoTasks: Task[] = [
  ...
  createDemoTask({
    ...
    type: "create_invoice",
    parent_id: "b0e1bccb-dcf3-4ee6-b30c-7a16105b0d46",
    state: TaskState.STARTED,
  }),
  createDemoTask({
    id: "8ec82025-23ff-444c-8f94-ab4e6c0565c9",
    type: "notify_user",
    parent_id: "3222416c-4967-4f1d-a39c-34cfa8085496",
  ...
  createDemoTask({
    ...
    parent_id: "7efdf689-0db9-4a99-b7a0-7ed5b30ab61b",
  }),
  createDemoTask({
    id: "5c2cd092-db2f-4b75-8e84-794e86a8d116",
    type: "notify_user",
    parent_id: "d1616fea-bca7-4a76-8e44-57180796be28",
  }),
  createDemoTask({
