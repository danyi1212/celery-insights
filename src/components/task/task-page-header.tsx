  ...
  return (
    ...
    >
      ...
      <div className="flex h-16 flex-col justify-end">
        ...
        {task ? <span className="text-xs text-muted-foreground">{task.id}</span> : <Skeleton className="h-4 w-64" />}
      </div>
      <div className={cn("transition-opacity duration-200", isHover ? "opacity-100" : "pointer-events-none opacity-0")}>
