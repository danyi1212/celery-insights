  ...
  return (
    <div className={cn("h-full w-full", isLarge ? "overflow-y-auto" : "overflow-y-clip")} ref={containerRef}>
      <div style={{ minHeight: totalHeight }}>
        {/* Time axis */}
        <div className="sticky top-0 z-10 flex bg-background/90 backdrop-blur-sm" style={{ height: TIME_AXIS_HEIGHT }}>
              ...
              >
                ...
                <div className="relative flex-1" style={{ height: ROW_HEIGHT }}>
                  <Tooltip>
                    ...
                    <TooltipContent side="top" className="max-w-72 bg-popover text-popover-foreground">
