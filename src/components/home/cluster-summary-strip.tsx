      ...
      <div className="grid gap-4 2xl:grid-cols-[minmax(0,1fr)_18rem]">
        <div className="flex min-w-0 flex-col gap-4">
          ...
          <div className="grid gap-3 sm:grid-cols-2 xl:grid-cols-4">
            <SummaryMetric label="Online Workers" value={onlineWorkers} icon={<Server className="size-4" />} />
            <SummaryMetric label="Recent Tasks" value={recentTaskCount} icon={<Workflow className="size-4" />} />
            <SummaryMetric
            ...
            <SummaryMetric
              label="Freshness"
              value={latestTaskUpdatedAt ? <TimeSince time={new Date(latestTaskUpdatedAt)} addSuffix /> : "No events"}
